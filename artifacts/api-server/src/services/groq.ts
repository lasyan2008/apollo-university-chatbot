...
// This model puts reasoning in content field, increase max_tokens to get final answer
const answer = rawContent || "I could not generate an answer. Please try again.";
